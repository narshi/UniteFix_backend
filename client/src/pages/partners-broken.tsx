          ...
          <div className="flex justify-between items-center mb-6">
            ...
            <Dialog open={isAddModalOpen} onOpenChange={setIsAddModalOpen}>
              ...
              <DialogContent className="max-w-2xl">
                <DialogHeader>
                  <DialogTitle>Add New Business Partner - Step {verificationStep} of 3</DialogTitle>
                  <DialogDescription>
                    {verificationStep === 1 && "Enter basic partner information"}
                    {verificationStep === 2 && "Verify contact details and services"}
                    {verificationStep === 3 && "Complete verification and review"}
                  </DialogDescription>
                </DialogHeader>
